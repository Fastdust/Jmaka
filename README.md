...
- TrashFix: генерация вертикальной карточки по PNG-шаблону (портретная «карточка» с рамкой/тенями).
- Trash experimental: экспериментальный режим Trash с изменяемой шириной окна.
...
- **TrashFix** — строгий режим вертикальной карточки:
...
- **Trash experimental** — экспериментальный режим Trash с изменяемой шириной окна (для проб разных компоновок).
